...
function ApplySkin(skin, clothes)
	...
	SetPedHeadOverlayColor		(playerPed, 4, 0,	Character['makeup_3'],			Character['makeup_4'])						-- Makeup Color
	...
	SetPedComponentVariation	(playerPed, 1,		Character['mask_1'],			Character['mask_2'], 2)			-- Tshirt
	SetPedComponentVariation	(playerPed, 3,		Character['arms'],				Character['arms_2'], 2)			-- torso parts
	SetPedComponentVariation	(playerPed, 4,		Character['pants_1'],			Character['pants_2'], 2)		-- Amrs
	SetPedComponentVariation	(playerPed, 5,		Character['bags_1'],			Character['bags_2'], 2)			-- decals
	SetPedComponentVariation	(playerPed, 6,		Character['shoes_1'],			Character['shoes_2'], 2)		-- pants
	SetPedComponentVariation	(playerPed, 7,		Character['chain_1'],			Character['chain_2'], 2)		-- shoes
	SetPedComponentVariation	(playerPed, 8,		Character['tshirt_1'],			Character['tshirt_2'], 2)		-- mask
	SetPedComponentVariation	(playerPed, 9,		Character['bproof_1'],			Character['bproof_2'], 2)		-- bulletproof
	SetPedComponentVariation	(playerPed, 10,		Character['decals_1'],			Character['decals_2'], 2)		-- chain
	SetPedComponentVariation	(playerPed, 11,		Character['torso_1'],			Character['torso_2'], 2)		-- Bag
